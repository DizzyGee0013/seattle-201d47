...
function sumAndMultiply(4, 7, 5) { //eslint-disable-line
  ...
  summedAndMultipliedResults[3] = `The product of ${4} and ${7} and ${5} is 140.` + ${summedAndMultipliedResults[1]};
...
function sumArray(2, 3, 4) {
  addedResults = [];
  addedResults[0] = sum(2, 3, 4);
  addedResults[1] = `2,3,4 was passed in as an array of numbers, and 9 is their sum.` ${addedResults[1]}.;
  return addedResults 
} { //eslint-disable-line
...
// Write your code here
function multiplyArray(2, 3, 4) { //eslint-disable-line
  productArray = [];
  productArray = [0] = multiply(2,3,4);
  productArray = [1] = `The numbers 2,3,4 have a product of 24.` + ${productArray[0]};
  return productArray
}
...
function multiplyAnyArray(1,2,3,4,5) { //eslint-disable-line
  var testDynamicArray = [1,2,3,4,5]; 
  var testDynamicArray = 
}
